...
export default function ShareModal({ onClose, participants }) {
  ...
  const title = "Random Name Silly Wheel - Free Online Tool";
  const description =
  ...
  return (
    <>
      <Helmet>
        <title>Share Random Name Silly Wheel</title>
        <meta
          name="description"
          content="Share this random name picker wheel with your friends and colleagues. Perfect for teachers, event planners, and team leaders."
        />

        {/* Primary Meta Tags */}
        <meta
          name="keywords"
          content="share wheel picker, social share, random picker share, wheel spinner share, share classroom tool"
        />

        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Share Random Name Silly Wheel" />
        <meta
          property="og:description"
          content="Share this amazing tool with your network!"
        />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Share Random Name Silly Wheel" />
        <meta
          name="twitter:description"
          content="Share this random name picker wheel with your network!"
        />
      </Helmet>
