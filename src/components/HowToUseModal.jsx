...
export default function HowToUseModal({ onClose }) {
      ...
      items: [
        {
          ...
          desc: "Student selection, group assignments, role distribution",
        },
        {
          name: "Team Building",
          desc: "Ice breakers, task allocation, team formation",
        },
        {
          name: "Decision Making",
          desc: "Random selection, fair choice, tournament matchups",
        },
        {
          name: "Event Planning",
          desc: "Prize draws, game organization, activity selection",
        },
      ],
    },
  ];
  ...
  return (
    <>
      <Helmet>
        <title>How to Use Random Name Silly Wheel - Complete Guide</title>
        <meta
          name="description"
          content="Learn how to use our random name picker wheel for classroom activities, team building, decision making, and more. Comprehensive guide with tips and best practices."
        />

        {/* Primary Meta Tags */}
        <meta
          name="keywords"
          content="random name picker, wheel spinner, classroom tool, team picker, random selector, decision maker, random generator, name picker wheel, random wheel, spin wheel"
        />
        ...
        <meta
          property="og:title"
          content="How to Use Random Name Silly Wheel- Complete Guide"
        />
        <meta
          property="og:description"
          content="Master the random name picker wheel with our comprehensive guide. Perfect for teachers, team leaders, and event organizers."
        />
        ...
        <meta name="twitter:title" content="Random Name Silly Wheel Guide" />
        <meta
          name="twitter:description"
          content="Complete guide to using our random name picker wheel for various activities and purposes."
        />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "HowTo",
            name: "How to Use Random Name Silly Wheel",
            description:
              "Complete guide to using the random name picker wheel for classroom activities, team building, and decision making.",
            step: [
              {
                "@type": "HowToStep",
            ...
            tool: {
              "@type": "Tool",
              name: "Random Name Silly Wheel",
              description:
                "Interactive wheel for random selection and decision making",
            },
          })}
        </script>
      </Helmet>
      ...
      >
        ...
        >
          ...
          <p className="text-white/80 mb-6">
            Welcome to Wheel of Names! Learn how to make the most of our random
            picker wheel.
          </p>
